...
export default function RuntimeDetailPage() {
  ...
  function openEditor() {
    ...
    setEditApiKey("");
    setEditImage(String((rt.provider_config as Record<string, unknown>)?.image ?? ""));
    setEditModelSource(
      ((rt.provider_config as Record<string, unknown>)?.model_source as "sync_from_server" | "download_from_hf") ?? "sync_from_server",
    );
    setEditing(true);
  }
              ...
              {isRemoteProvider ? (
                ...
                <>
                  ...
                  <TextField
                    ...
                    fullWidth
                    placeholder={t("llm_runtimes.image_auto_placeholder", "Leave blank for auto-detect")}
